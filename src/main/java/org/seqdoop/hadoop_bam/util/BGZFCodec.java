 ...
 * whether a file is a BGZF file, or merely a regular gzip file. BGZFCodec will read
 * the start of the file to look for BGZF headers to detect the type of compression.
 * </p>
 * <p>
 * BGZFCodec will read BGZF or gzip files, but currently always writes regular gzip files.
 * </p>
 * <p>
 * To use BGZFCodec, set it on the configuration object as follows. This will
